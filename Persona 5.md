...
## Soporte
## Pasiva 
# Personas de los miembros del equipo
## Morgana
- Garudyne  
- Magarudyne  
- Miracle Rush  
- Samarecarm / Deblilitate  
- Salvation  
- Wind Amp  
- Wind Boost  
- Evade Elec
...
- Concentrate  
- High Energy  
- Tarunda / Spell Master  
- Evade Ice
## Yusuke
- Bufudyne  
- Mabufudyne / Arms Master  
- Brave Blade  
- Vorpal Blade  
- Charge  
- Hyakka Ryouran  
- High Counter / Ali Dance  
- Evade Fire
## Makoto
- Atomic Flare  
- Mafreidyne  
...
- Apt Pupil  
- Evade Curse
# Persona para los palacios
## Palacio de Kamoshida
### Obariyon
Es la persona que usaremos contra el jefe.
- Kelpie: Arsene + Mandrake 
- Jack o lantern:
## Palacio de Madarame
### Makima
Lo usaremos para farmear al enemigo de aura roja del palacio, especializa en daño de nuclear. debe tener intense focus como habilidad interna.
- Onmaraki: Obariyon + silky
- Kodama: Angel + Arsene 
	- Angel: Onmaraki + Arsene

debe heredar lo siguiente: Rakunda, Eiha y Garu
### Shiki-Ouji
Uno de los mejores persona del juego, debe tener como habilidad interna Mighty Gaze. 
- Slime: Bicorn + pixie
- Regent
debe heredar Mapsi, Maeiha, Makouha y Magaru
## Palacio de Kaneshiro
### Shiki-Ouji
Seguimos mejorando esta persona, pero considerando lo siguiente
- Cambiar el **Double Shot** por **Triplete Down**: se consigue usando la silla eléctrica en alarma con el mismo persona
- Usando el encarcelamiento le ponemos Evade Nuke, pero no necesario.
## Palacio de Futaba
### Shiki-Ouji
Ahora con la mecánica de la horca, intentamos traspasar mejoras en las habilidades de área, esto siempre se debe hacer en modo alarma. Además, con la misma alarma podemos mejorar sus estadística haciendo lo siguiente
1. Fusionamos una persona en modo alarma
2. Ahora vamos a la horca le damos cualquier persona como sacrificio
3. Ahora usamos a la persona fusionada como sacrificio para mejorar las estadísticas de  Shiki-Ouji
 Este persona lo podemos utilizar para farmear al enemigo con ahora roja del palacio, que es Anubis. La idea es dejarlo en modo automático 
## Palacio de Okumura
### Shiki-Ouji
...
| Personaje |                       Arma Melee                       |                  Arma a Distancia                   |
| :-------- | :----------------------------------------------------: | :-------------------------------------------------: |
